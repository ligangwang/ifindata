...
class AppConfig {
  ...
  static bool get useMockServices {
    ...
    return _environment == 'development' || 
           _environment == 'mock' || 
           const bool.fromEnvironment('USE_MOCK_SERVICES', defaultValue: _kDebugMode);
  }
  ...
  static String get apiBaseUrl {
    switch (_environment) {
      case 'production':
        return const String.fromEnvironment('API_BASE_URL', defaultValue: 'https://api.ifindata.com');
      case 'staging':
        return const String.fromEnvironment('API_BASE_URL', defaultValue: 'https://staging-api.ifindata.com');
      default:
  ...
  static String get firebaseProjectId {
    return const String.fromEnvironment('FIREBASE_PROJECT_ID', defaultValue: 'ifindata-dev');
  }
  
  // Stripe Configuration
  static String get stripePublishableKey {
    if (isProduction) {
      return const String.fromEnvironment('STRIPE_PUBLISHABLE_KEY_PROD', defaultValue: '');
    } else {
      return const String.fromEnvironment('STRIPE_PUBLISHABLE_KEY_TEST', defaultValue: '');
    }
  }
